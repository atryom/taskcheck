...
class UserStatusesControllerTest < ActionController::TestCase
  ...
  test "should create user_status" do
    assert_difference('UserStatus.count') do
      post :create, user_status: { name: @user_status.name, order_num: @user_status.order_num, user_id: @user_status.user_id }
    end
  ...
  test "should update user_status" do
    patch :update, id: @user_status, user_status: { name: @user_status.name, order_num: @user_status.order_num, user_id: @user_status.user_id }
    assert_redirected_to user_status_path(assigns(:user_status))
  end
